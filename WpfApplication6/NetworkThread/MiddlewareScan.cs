            ...
            while (!bTerminate)
            {
                ...
                try
                {
                    ...
                    if (networkmain.connected == false)
                    {
                        ...
                        {
                            NetworkAddress = "Connected to MICServer " + address.ToString() + " Port : " + node.InnerText + " Fail"+ "  V9.5.13.21Z";
                        ...
                        NetworkAddress = "Connected to MICServer " + address.ToString() + " Port : " + node.InnerText + "  V9.5.13.21Z";
                    ...
                    if (evt_FinishLabelRequest.WaitOne(0))
                    {
                                                                              ...
                                                                              //update label tracking data
                        {
                            ...
                            #endregion
                            SendFL = Scanboxid;
                            while ((!networkmain.updatefltrackinginfomation(Scanboxid,OEEid.ToString()) && !bTerminate))
                            {
                                Thread.Sleep(100);
                            }

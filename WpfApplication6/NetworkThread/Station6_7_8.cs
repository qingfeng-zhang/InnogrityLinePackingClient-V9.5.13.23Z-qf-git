...
//                                        rq.UpdStNobyID(8, int.Parse(OEEid8));
        ...
        public void Set_PLC_Error2(int index, int errValue)
        {
            PLCQueryRx6[index + 1] = (byte)((errValue & 0xff00) >> 8);
            PLCQueryRx6[index] = (byte)errValue;
        }
        public void ST7_Error()
        {
            #region Sation 7 error code

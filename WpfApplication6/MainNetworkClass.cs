    ...
    partial class MainNetworkClass : INotifyPropertyChanged
    {
     ...
     public Logger SealerResult = LogManager.GetLogger("SealerResultFromMiddleware");
      ...
      public bool CheckTrackingLabel(string TrackingLabel)//update data
        ...
        private delegate bool updatefltrackinginfomationdelegate(string text, string id);
        public bool updatefltrackinginfomation(string boxid,string OEEid) //update data
        {
            ...
            {
                // or BeginInvoke()
                object obj = Application.Current.Dispatcher.Invoke(DispatcherPriority.Send, new updatefltrackinginfomationdelegate(updatefltrackinginfomation), boxid,OEEid);
                return (bool)obj;
            }
            return false;
        }

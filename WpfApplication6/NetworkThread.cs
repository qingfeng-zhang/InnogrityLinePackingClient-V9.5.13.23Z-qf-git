        ...
        public void Station07PrinterTh(object msgobj)
        {
            ...
            while (!bTerminate)
            {
                if (evt_Station07PrintReq.WaitOne(100))
                {
                    ...
                    {
                        //print fail set Error code
                        log.Error("Station07PrinterTh exception");
            ...
            while (!bTerminate)
            {
                if (evt_Station07ESDPrintReq.WaitOne(100))
                {
                    try
                    {
                        ...
                        Station7Log.Info("Station 7 ESD printer " + ST07Rotatary_StrESD);
      ...
      public bool UpdatePLCFinishingLabelDMAddressFor7ESD(string strtrackingLabel)
        {
            try
            {
                ...
                else
                {
                    ...
                    tmpbyte = Encoding.ASCII.GetBytes("OK");
                    Array.Copy(tmpbyte, 0, PLCWriteCommand6,461,2);//D5420
                    Station7Log.Info("Station 7 ESD Tarcking Label OK " + st7ESDtrack);
                }               
                       ...
                       // XmlNode VisionImgFile = doc.SelectSingleNode(@"/CONFIG/LABELVISIONST04/IMGFOLDER");  //need to create share folder for Image
                        ...
                        try
                        {
                            ...
                            if (PLCQueryRx[PLCQueryRx_DM157 + 18] == 0x2)
                            {
                                ...
                                OM2.Info("Station 4 Vision Start");
                            ...
                            else if(PLCQueryRx[PLCQueryRx_DM157 + 18] == 0x3)
                            {
                                bool[] rst = { true, true };
                                ...
                                OM2.Info("ST4 Omron Filter " + " " + PrintlabelName[i] + " " + isThisTray);
                                networkmain.stn4log = "ST4 Omron Filter " + PrintlabelName[i] + " " + isThisTray;
                                    ...
                                    OM2.Info("Station 4 Vision AutoMeasure2"); //Double snap sequence
